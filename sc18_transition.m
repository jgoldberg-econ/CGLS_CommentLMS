...
function [transg, transg_comp, LI,vLovF,mu,g1,vLovF1,vL1,vL2,vF1,vF2] = sc18_transition(T,r,dr,eps,lamb, pi, kap,pishrvec, percent_adjust, lL, lF, l0,sig)
n = (length(pi)-1)/2;
nperiods = T;
r1 = r  ; r2 = r1-dr;
...
% that:
%
% (i) Lines 37-52 calculate the productivity growth composition effects
% in Equation 1 of our Comment.  transg(t) corresponds to the change in the
...
% composition effects.  
%
% (ii) Lines 10-12 tell MATLAB to alter the guess for the investment
% success rates whenever the new discount rate is less than 50 basis
% points; for example, this condition will be satisfied when
