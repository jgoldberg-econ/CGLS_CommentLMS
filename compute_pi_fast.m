...
% These lines provide additional output from this function and 
% are consistent with LMS's Section 4.2 (``Firms' pricing and investment decisions'') 
% together with the assumption in their quantitative analysis that
% ``the production cost of the follower is at most lambda^{\bar{s}} times the cost of the leader,
% and we set \bar{s}=1.'' (p. 213).  A derivation is available from the authors (CGLS) upon request.

% This additional output is used to calculate composition effects.  
